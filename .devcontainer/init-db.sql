...
-- This script is run automatically by the PostgreSQL dev container feature

-- Create application databases
CREATE DATABASE timebot_dev;
CREATE DATABASE timebot_test;

-- Connect to the development database to set up schema
\c timebot_dev;
...
-- Set up the test database with the same schema
\c timebot_test;
